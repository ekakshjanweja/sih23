...
const lightColorScheme = ColorScheme(
  ...
  // onTertiary: Color(0xFFFFFFFF), --> ontertiary being edited for use in the reply enclosure! (use onsecondary instead - theyre the same)
  onTertiary: Color(0x77492532),
...
TextTheme darkTextTheme(BuildContext context) {
  return GoogleFonts.nunitoSansTextTheme(Theme.of(context).textTheme)
      ...
      .copyWith(
        ...
        headlineSmall: TextStyle(color: darkColorScheme.onSurfaceVariant),
        titleSmall: TextStyle(color: darkColorScheme.onSurfaceVariant),
        labelLarge: TextStyle(color: darkColorScheme.onSurfaceVariant),
        titleLarge: TextStyle(color: darkColorScheme.onSurfaceVariant),
        titleMedium: TextStyle(color: darkColorScheme.onSurfaceVariant),
        labelSmall: TextStyle(color: darkColorScheme.onSurfaceVariant),
      );
}

// final lightTextTheme = GoogleFonts.nunitoSansTextTheme()
//     .apply(
//       displayColor: lightColorScheme.onBackground,
//     )
//     .copyWith(
...
// final darkTextTheme = GoogleFonts.nunitoSansTextTheme()
//     .apply(
//       displayColor: darkColorScheme.onBackground,
//     )
//     .copyWith(
